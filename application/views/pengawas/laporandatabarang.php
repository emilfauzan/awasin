            ...
            <div class="card-body">
                ...
                <form>
                    <div class="form-group">
                        ...
                        <input type='text' class="form-control" id="juduldatabarang" rows="3" value="Laporan Data Barang">
                        </input>
                        <br>
                        <div class="row">
                            <div class="col-lg-3 d-inline">
                                <a target="_blank" href="#" id='print_button' onclick="printpdf()" class="btn btn-info btn-icon-split">
                                    ...
                                    <span class="text">Print Laporan Data Barang</span>
                                </a>
...
<script>
    ...
    function printpdf() {
        ...
        if (type == 1) {
            window.open(url + '/awasin/pengawas/pdf/barang?type=' + type + '&year=' + year + '&title=' + title)
        } else {
            window.open(url + '/awasin/pengawas/pdf/barang?type=' + type + '&year=' + year + '&month=' + month + '&title=' + title)
        }
    }
</script>
<!-- End of Main Content -->