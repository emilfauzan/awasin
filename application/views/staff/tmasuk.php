    ...
    <div class="row">
        <div class="col-lg">
            ...
            <div class="card shadow">
                <div class="card-body">
                    <?= form_open_multipart('staff/settanggaltmasuk') ?>
                    <!-- <form method="post" action=""> -->
                    <div class="row">
                        <div class="form-group col-lg-3 mb-3 ">
                            <h4 class="card-title">Tanggal Transaksi</h4>
                            <p class="card-text">Masukkan tanggal transaksi.</p>
                            <input type="date" name="tanggaltmasuk" class="form-control mb-3 shadow ">
            ...
            <a href="" class="btn btn-primary btn-icon-split mb-3 shadow " data-toggle="modal" data-target="#newTmasukModal">
                ...
                <tbody>
                    ...
                    foreach ($keterangan as $m) : ?>
                        <tr>
                            ...
                            <td><?= $m['keterangan']; ?></td>
                            <td>
                                <a href="<?= base_url('staff/edittmasuk'); ?><?= '?id=' . $m['idtransaksi']; ?>" class=" shadow btn btn-success btn-circle btn-sm modalEditBarang" data-toggle="modal" data-target="#editDataBarangModal<?= $m['idtransaksi']; ?>" type="button" onclick="return edit(<?= $m['idtransaksi'] ?>)">
...
<!-- Modal Tambah Data -->
<div class="modal fade" id="newTmasukModal" tabindex="-1" aria-labelledby="newTmasukModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newTmasukModalLabel">Tambah Transaksi Barang Masuk</h5>
            ...
            <div class="modal-body">
                <?= form_open_multipart('staff/tmasuk'); ?>
                ...
                <!-- JENIS TRANSAKSI -->
                <label for="text" class="col-form-label"></label>
                <input type="hidden" class="form-control" id="jenis_transaksi" name="jenis_transaksi" value="1"></input>
...
foreach ($keterangan as $m) : $no++; ?>
    ...
    <div class="modal fade" id="editDataBarangModal<?= $m['idtransaksi']; ?>" tabindex="-1" aria-labelledby="editDataBarangModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="editDataBarangModalLabel<?= $m['idtransaksi']; ?>">Edit Data Barang</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-body">
                    <form action="/awasin/staff/edittmasuk?id=<?= $m['idtransaksi']  ?>" method="POST" id="form-<?= $m['idtransaksi']  ?>">
    ...
    <script>
        function resetFilter() {
            ...
            window.location.href = url + '/awasin/staff/tmasuk'
        }
    </script>
<?php endforeach; ?>